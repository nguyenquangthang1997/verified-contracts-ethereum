...
contract Trading is DSMath, TokenUser, Spoke, TradingSignatures {
    ...
    function updateAndGetQuantityHeldInExchange(address ofAsset) public returns (uint) {
        ...
        // quantity in custody across exchanges
        uint totalSellQuantityInApprove;
        // quantity of asset in approve (allowance) but not custody of exchange
        ...
        // Since quantity in approve is not actually in custody
    }
