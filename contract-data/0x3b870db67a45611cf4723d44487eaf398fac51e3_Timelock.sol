...
contract Timelock is ITimelock, AccessControl {
    ...
    constructor(address governor, address executor) AccessControl() {
        delay = 0;
        // delay is set to zero initially to allow testing and configuration. Set to a different value to go live.
        ...
        _grantRole(ITimelock.setDelay.selector, address(this));
        // bytes4(keccak256("setDelay(uint256)"))
