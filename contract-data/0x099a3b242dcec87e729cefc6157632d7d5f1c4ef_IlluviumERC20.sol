...
contract IlluviumERC20 is AccessControl {
   ...
   */
    function unsafeTransferFrom(address _from, address _to, uint256 _value) public {
        ...
        require(tokenBalances[_from] >= _value, "ERC20: transfer amount exceeds balance");
        // Zeppelin msg
    ...
    function burn(address _from, uint256 _value) public {
        ...
        if (!isSenderInRole(ROLE_TOKEN_DESTROYER)) {
            ...
            if (_from != msg.sender) {
                ...
                require(_allowance >= _value, "ERC20: burn amount exceeds allowance");
                // Zeppelin msg
        ...
        require(tokenBalances[_from] >= _value, "ERC20: burn amount exceeds balance");
        // Zeppelin msg
