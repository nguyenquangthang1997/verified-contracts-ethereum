...
contract Chameleon is IERC721, Ownable, Functional {
    ...
    constructor() {
        ...
        reservedTokens = 300;
        // reserved for giveaways and such
    ...
    */
    ...
    function discountMint(uint256 qty) external payable reentryLock {
        ...
        require(checkForDiscount(_msgSender()), "Discount Not Active");
        //check for holders
    ...
    */
    ...
    function totalSupply() external view returns (uint256) {
        ...
        return numberMinted;
        //stupid bs for etherscan's call
    ...
    function getBalance(address tokenAddress) view external returns (uint256) {
        ...
        //temporary fix to report in finneys
