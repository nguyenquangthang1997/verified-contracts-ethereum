...
contract DSPause is DSAuth, DSNote {
    ...
    modifier wait {require(msg.sender == address(proxy), "ds-pause-undelayed-call");
        _;}
...
contract DSPauseProxy {
    ...
    modifier auth {require(msg.sender == owner, "ds-pause-proxy-unauthorized");
        _;}
...
contract Vow is LibNote {
    ...
    function rely(address usr) external note auth {require(live == 1, "Vow/not-live");
        wards[usr] = 1;}
