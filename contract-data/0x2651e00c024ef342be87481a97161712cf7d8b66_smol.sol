...
contract ElevenEleven is Context, Ownable, ERC165, IElevenEleven, IERC721Metadata {
    ...
    function getNFTPrice() public view returns (uint256[2] memory) {
        ...
        if (currentSupply >= 1096) {
            ...
            return [uint256(5000000000000000000), 1];
            // 1096 - 1110 1 SMOL

        } else if (currentSupply >= 1076) {

            return [uint256(666600000000000000), 0];
            // 1076 - 1095 0.65 ETH
            ...
            return [uint256(555500000000000000), 0];
            // 976 - 1025 0.55 ETH
            ...
            return [uint256(444400000000000000), 0];
            // 826 - 925 0.45 ETH
            ...
            return [uint256(333300000000000000), 0];
            // 626 - 775 0.35 ETH
            ...
            return [uint256(222200000000000000), 0];
            // 327 - 550 0.25 ETH
            ...
            return [uint256(111100000000000000), 0];
            // 1 - 251 0.15 ETH
