...
contract BAToken is StandardToken, SafeMath {
...

    {
        ...
        // Deposit Brave Intl share

        CreateBAT(batFundDeposit, batFund);
        // logs Brave Intl fund
    ...
    function createTokens() payable external {
        ...
        // safeAdd not needed; bad semantics to use here
    ...
    function finalize() external {
        ...
        // send the eth to Brave International
    ...
    function refund() external {
        ...
        if (totalSupply >= tokenCreationMin) throw;
        // no refunds if we sold enough

        if (msg.sender == batFundDeposit) throw;
        // Brave Intl not entitled to a refund
        ...
        // should be safe; previous throws covers edges
