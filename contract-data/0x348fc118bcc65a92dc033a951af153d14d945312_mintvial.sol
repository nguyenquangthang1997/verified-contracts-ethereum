...
contract Mintvial is ERC1155, Ownable, ERC1155Burnable {
    ...
    constructor() ERC1155("ipfs://QmQqMF7izNAaU9CY3qV9ZGs4Aksv6ywjx8261khgzQbReW") {
        ...
        authorizedContract[0x20fd8d8076538B0b365f2ddd77C8F4339f22B970] = 721;
        // Mintdisc 1 - 721

        authorizedContract[0x25708f5621Ac41171F3AD6D269e422c634b1E96A] = 721;
        // Mintdisc 3 - 721

        authorizedContract[0x50B8740D6a5CD985e2B8119Ca28B481AFa8351d9] = 721;
        // RTFKT Easter Eggs - 721

        authorizedContract[0xc541fC1Aa62384AB7994268883f80Ef92AAc6399] = 721;
        // Space Drip 1.2 - 721

        authorizedContract[0xd3f69F10532457D35188895fEaA4C20B730EDe88] = 721;
        // Space Drip 1 - 721

        authorizedContract[0x2250D7c238392f4B575Bb26c672aFe45F0ADcb75] = 721;
        // FewoShoes - 721

        authorizedContract[0xAE3d8D68B4F6c3Ee784b2b0669885a315BA77C08] = 721;
        // Punk sneakers - 721

        authorizedContract[0xDE8350B34b2e6FC79aABCc7030fD9a862562E821] = 721;
        // Metagrails -> 721
        ...
        authorizedContract[0xCD1DBc840E1222A445be7C1D8ecB900F9D930695] = 1155;
        // Jeff Staples - 1155
        ...
        if (publicSales == true) {
            ...
            for (uint256 i = 0; i < contractIds.length; i++) {
                ...
                if (authorizedContract[contractIds[i]] == 721) {
                    ...
                    // If the contract is neither flagged as 721 or 1155
    ...
    function forceMigrateToken(uint256 id) public onlyOwner {
        ...
        require(balanceOf(msg.sender, id) > 0, "Doesn't own the token");
        // Kept so no one can't force someone else to open a CloneX
        ...
        clonexContract.mintTransfer(msg.sender);
        // Mint the ERC-721 token
