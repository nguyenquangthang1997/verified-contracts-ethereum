...
contract CauldronV2CheckpointV1 is BoringOwnable, IMasterContract {
    ...
    function liquidate(
...

        {
            ...
            uint256 distributionAmount = (allBorrowAmount.mul(LIQUIDATION_MULTIPLIER) / LIQUIDATION_MULTIPLIER_PRECISION).sub(allBorrowAmount).mul(DISTRIBUTION_PART) / DISTRIBUTION_PRECISION;
            // Distribution Amount
