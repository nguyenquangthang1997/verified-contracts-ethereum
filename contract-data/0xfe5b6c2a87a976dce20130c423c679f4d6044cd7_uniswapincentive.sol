...
abstract contract UniRef is IUniRef, OracleRef {
    ...
    function _getFinalPrice(
        ...
        int256 amountFeiWithFee = amountFei > 0 ? amountFei.mul(997).div(1000) : amountFei;
...
contract UniswapIncentive is IUniswapIncentive, UniRef {
...

    {
        ...
        if (penalty != 0) {
            ...
            fei().burnFrom(address(pair), penalty);
...

    {
        ...
        Decimal.D256 memory multiplier = deviation.mul(deviation).mul(100);
        // m^2 * 100
