...
contract VRF {
   ...
   */
...

    {
        ...
        // x ordinate of multiplicand

        uint8 v = multiplicand[1] % 2 == 0 ? 27 : 28;
        // parity of y ordinate
...
@notice Computes elliptic-curve sum, in projective co-ordinates
  ...
  */
    ...
    internal pure returns (uint256 sx, uint256 sy, uint256 sz) {
        ...
        uint256 dx;
        // Accumulates denominator from sx calculation
        ...
        uint256 dy;
        // Accumulates denominator from sy calculation
   ...
   */
    ...
    internal view returns (uint256 output) {
        ...
        uint256[2] memory pk;
        // parse proof contents into these variables
...
contract VRFCoordinator is VRF, VRFRequestIDBase {
   ...
   */
...

    {
        ...
        assert(_feePaid < 1e27);
        // Total LINK fits in uint96
   ...
   */
    ...
    internal view returns (bytes32 currentKeyHash, Callback memory callback,
        ...
        randomness = VRF.randomValueFromVRFProof(_proof);
        // Reverts on failure
