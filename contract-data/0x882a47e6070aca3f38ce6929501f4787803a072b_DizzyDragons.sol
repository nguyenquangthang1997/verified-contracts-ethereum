...
contract DizzyDragons is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 maxDragonSupply) ERC721(name, symbol) {
        ...
        _shareholders[0] = 0x1EfC0E664fAe4D145Be8599d980CB0a5D7BB3c7A;
        // Rob
        _shareholders[1] = 0xDc8Eb8d2D1babD956136b57B0B9F49b433c019e3;
        // Treasure-Seeker
        _shareholders[2] = 0xA41A4b84D74E085bd463386d55c3b6dDe6aa2759;
        // Ben
        _shareholders[3] = 0x364E6a561879e5B2254F4Aa540f8B03d7DA94689;
        // Oliver
        _shareholders[4] = 0xbfeaF79CC5741Ae4D330a4E201f1DB99B7C49f26;
        // Matt
        _shareholders[5] = 0x25aA0cA7D31e401c0343B90817D8635698465B7b;
        // Giveaway wallet
        _shareholders[6] = 0xa22c29fbe82646868960fE0cEDf20317d7a04a24;
        // Community wallet
