...
contract DXswapPair is IDXswapPair, DXswapERC20 {
    ...
    function initialize(address _token0, address _token1) external {
        ...
        require(msg.sender == factory, 'DXswapPair: FORBIDDEN');
        // sufficient check
    ...
    function setSwapFee(uint32 _swapFee) external {
        ...
        require(_swapFee <= 1000, 'DXswapPair: FORBIDDEN_FEE');
...
contract DXswapFactory is IDXswapFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        require(getPair[token0][token1] == address(0), 'DXswapFactory: PAIR_EXISTS');
