...
Initializable
{
    ...
    function initialize(
        ...
        normalTaxRate = 2000;
        // 20% goes to the vision sharing farm, 80% is swapped to stable coin and goes to the labor market
        taxRateForUndeclared = 5000;
        // 50% goes to the vision farm when the budget is undeclared.
    ...
    function compensateInStream(
        ...
        projectFund[projectId] = projectFund[projectId] - amount;
        // "require" protects underflow
        IERC20(commitToken).approve(sablier, amount);
