...
abstract contract Strategy88MphBase is StrategyBase, IERC721Receiver {
    ...
    // start vesting index, usually increased by deposit

    uint256 public startVestingIdx = 0;

    // active vesting number, but bear in mind there isn't a 1-to-1 link between vests and deposits though

    uint256 public activeVestingNum = 0;



    // Keeper bots, harvesting and depositing/withdrawing
