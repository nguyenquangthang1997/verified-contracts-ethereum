...
abstract contract ConvexStable is BaseStrategy {
...

    {
        ...
        if (_balance < _amountNeeded) {
            ...
            // this should be 0. o/w there must be an error
    ...
    function _claimableBasicInETH() internal view returns (uint256) {
        ...
        uint256 maxSupply = 1e8 * 1e18;
        // 100m

        uint256 reductionPerCliff = 1e5 * 1e18;
        // 100k
...
contract Strategy is ConvexStable {
    ...
    constructor(address _vault) public ConvexStable(_vault) {
        ...
        isClaimRewards = true;
        // default is true, turn off in emergency

        isClaimExtras = true;
        // add this if there are extra rewards
