    ...
    function transfer(address to, uint256 amount) public returns (bool) {
        ...
        if (amount != 0) {
            ...
            if (msg.sender != to) {
                ...
                // Moved down so low balance calls safe some gas
...
contract KashiPairMediumRiskV1 is ERC20, BoringOwnable, IMasterContract {
    ...
    function init(bytes calldata data) public payable override {
        ...
        accrueInfo.interestPerSecond = uint64(STARTING_INTEREST_PER_SECOND);
        // 1% APR, with 1e18 being 100%
    ...
    function accrue() public {
        ...
        uint256 feeAmount = extraAmount.mul(PROTOCOL_FEE) / PROTOCOL_FEE_DIVISOR;
        ...
        if (utilization < MINIMUM_TARGET_UTILIZATION) {
            ...
            if (_accrueInfo.interestPerSecond < MINIMUM_INTEREST_PER_SECOND) {
                ...
                _accrueInfo.interestPerSecond = MINIMUM_INTEREST_PER_SECOND;
                // 0.25% APR minimum
            ...
            if (newInterestPerSecond > MAXIMUM_INTEREST_PER_SECOND) {
                ...
                newInterestPerSecond = MAXIMUM_INTEREST_PER_SECOND;
                // 1000% APR maximum
    ...
    function liquidate(
        ...
        if (!open) {
            ...
            uint256 feeShare = extraShare.mul(PROTOCOL_FEE) / PROTOCOL_FEE_DIVISOR;
            // % of profit goes to fee
