...
contract NiftyDegen is NameableCharacter {
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 9500) return 280000000000000000;
        // 9500 - 9900 0.28 ETH
        if (currentSupply >= 8500) return 250000000000000000;
        // 8501 - 9500 0.25 ETH
        if (currentSupply >= 6500) return 220000000000000000;
        // 6501 - 8500 0.22 ETH
        if (currentSupply >= 4500) return 190000000000000000;
        // 4501 - 6500 0.18 ETH
        if (currentSupply >= 2500) return 160000000000000000;
        // 2501 - 4500 0.15 ETH
        if (currentSupply >= 1000) return 130000000000000000;
        // 1001 - 2500 0.13 ETH
