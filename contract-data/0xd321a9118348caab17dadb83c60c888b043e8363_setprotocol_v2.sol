...
library AllocatorMathLibrary {
...

    {
        ...
        if (scaledValue >= 0x100000000000000000000000000000000) {scaledValue >>= 128;
            nearestValue <<= 128;}

        if (scaledValue >= 0x10000000000000000) {scaledValue >>= 64;
            nearestValue <<= 64;}

        if (scaledValue >= 0x100000000) {scaledValue >>= 32;
            nearestValue <<= 32;}

        if (scaledValue >= 0x10000) {scaledValue >>= 16;
            nearestValue <<= 16;}

        if (scaledValue >= 0x100) {scaledValue >>= 8;
            nearestValue <<= 8;}

        if (scaledValue >= 0x10) {scaledValue >>= 4;
            nearestValue <<= 4;}

        if (scaledValue >= 0x4) {scaledValue >>= 2;
            nearestValue <<= 2;}

        if (scaledValue >= 0x2) nearestValue <<= 1;
