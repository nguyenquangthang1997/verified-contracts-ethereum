...
contract DSPauseProxy {
    ...
    modifier auth {require(msg.sender == _owner, "ds-pause-proxy-unauthorized");
        _;}
...
contract DSPause is IDSPause {
    ...
    modifier wait {require(msg.sender == address(_proxy), "ds-pause-undelayed-call");
        _;}

    modifier auth {require(msg.sender == _owner, "ds-pause-unauthorized");
        _;}
