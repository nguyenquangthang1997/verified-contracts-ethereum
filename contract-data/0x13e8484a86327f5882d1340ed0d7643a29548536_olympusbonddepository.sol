...
contract OlympusBondDepository is Ownable {
    ...
    function _deposit(
        ...
        uint price = bondPriceInDAI();
        // DAI price of bond (for depositor info)



        require(maxPrice_ >= bondPrice(), "Slippage limit: more than max price");
        // slippage protection
        ...
        uint padding = value.div(10000000);
        // leaves dust to ensure against underflow
