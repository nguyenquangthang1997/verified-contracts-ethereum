...

{
...

    {
        ...
        if ((elapsed >= closedPresaleStart) && (elapsed < presaleStart)) {
            ...
            uint256 elapsedSinceAuctionStart = elapsed.sub(auctionStart);
            // Elapsed time since auction start

            uint256 totalPriceDiff = startingPrice.sub(endingPrice);
            // Total price diff between starting and ending price
            ...
            // Amount of price changes in the auction

            uint256 priceChangeAmount = totalPriceDiff.div(numPriceChanges);
            // Amount of price change per instance of price change
            ...
            currentPrice = startingPrice.sub(totalPriceChangeAmount);
            // Starting price minus total price change
