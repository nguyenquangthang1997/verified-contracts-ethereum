...
contract IERC20Token {
    ...
    function allowance(address _owner, address _spender) public view returns (uint256) {_owner;
        _spender;
        this;}
...
contract ConverterBase is IConverter, TokenHandler, TokenHolder, ContractRegistryClient, ReentrancyGuard {
    ...
    */
    ...
    function() external payable {
        ...
        // require(hasETHReserve(), "ERR_INVALID_RESERVE");
...
contract IConverterFactory {
    ...
    function customFactories(uint16 _type) public view returns (ITypedConverterCustomFactory) {_type;
        this;}
}
