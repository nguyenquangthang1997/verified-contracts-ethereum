...
contract ChainFaces is ERC721Full {
    ...
    constructor() ERC721Full("ChainFaces", "ʕ◕ᴥ◕ʔ") public {
        ...
        _registerToken(alpha1, 0, 100, 100, 16736095, 0);
        //alpha1 face

        _registerToken(alpha2, 5, 0, 100, 16777215, 0);
        //alpha2 face

        _registerToken(alpha3, 5, 0, 100, 16777215, 0);
        //alpha3 face

        _registerToken(alpha4, 5, 0, 100, 16777215, 0);
        //alpha4 face

        _registerToken(alpha5, 5, 0, 100, 16777215, 0);
        //alpha5 face

        _registerToken(alpha6, 5, 0, 100, 16777215, 0);
        //alpha6 face

        _registerToken(alpha7, 5, 0, 100, 16777215, 0);
        //alpha7 face

        _registerToken(alpha8, 5, 0, 100, 16777215, 0);
        //alpha8 face
