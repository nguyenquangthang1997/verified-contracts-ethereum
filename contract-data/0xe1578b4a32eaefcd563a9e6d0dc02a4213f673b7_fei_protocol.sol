...
abstract contract Timed {
    ...
    function remainingTime() public view returns (uint256) {
        ...
        // duration always >= timeSinceStart which is on [0,d]
    ...
    function timeSinceStart() public view returns (uint256) {
        ...
        // block timestamp always >= startTime
...
abstract contract BondingCurve is IBondingCurve, OracleRef, PCVSplitter, Timed {
...

    {
        ...
        return Math_4.max(amountOut, _getBondingCurveAmountOut(adjustedAmount));
        // Cap price at buffer adjusted
...
contract EthBondingCurve is BondingCurve {
...

    {
        ...
        SHIFT = scale / 3;
        // Enforces a .50c starting price per bonding curve formula
...

    {
        ...
        uint256 shiftTotal = _shift(totalPurchased);
        // k + C
        ...
        return (radicand.cubeRoot() ** 2).sub(shiftTotal);
        // result - (k + C)
