...
abstract contract PendleMarketBase is IPendleMarket, PendleBaseToken, WithdrawableV2 {
    ...
    */
    ...
    function bootstrap(
        ...
        _updateLastParamK();
        // update paramK since this is the first time it's set
    ...
    */
    ...
    function addMarketLiquidityDual(
        ...
        _updateLastParamK();
        // update paramK since it has changed due to a non-swap event
    ...
    function addMarketLiquiditySingle(
        ...
        */
        ...
        _updateLastParamK();
        // update paramK since it has changed not due to swap
    ...
    function removeMarketLiquiditySingle(
        ...
        */
        ...
        _updateLastParamK();
        // update paramK since it has changed by a non-swap event
    ...
    function _updateWeight() internal {
        ...
        (uint256 xytBalance, uint256 tokenBalance, ,) = readReserveData();
        // unpack data

        (uint256 xytWeightUpdated, , uint256 currentRelativePrice) = _updateWeightDry();

        writeReserveData(xytBalance, tokenBalance, xytWeightUpdated);
        // repack data
...

    {
        ...
        (, , uint256 xytWeight, uint256 tokenWeight) = readReserveData();
        // unpack data
    ...
    */
    ...
    function _initializeLock() internal {
        ...
        uint256 duration = expiry.sub(xytStartTime);
        // market expiry = xyt expiry
