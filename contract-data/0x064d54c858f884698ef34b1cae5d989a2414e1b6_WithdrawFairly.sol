...
contract WithdrawFairly is Ownable {
    ...
    constructor(){
        ...
        parts.push(Part(0x764789dF2592764EeF2408E9524C4eCadDCb31C9, 50, 0));
        // creator

        parts.push(Part(0x8a73c4777163c467b2eee9cd6858B2A56D376B70, 0, 50));
        // creator

        parts.push(Part(0xcBCc84766F2950CF867f42D766c43fB2D2Ba3256, 50, 50));
        // dev
