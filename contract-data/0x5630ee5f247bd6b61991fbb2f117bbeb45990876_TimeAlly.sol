...
contract TimeAlly {
    ...
    constructor(address _tokenAddress, address _nrtAddress) public {
        ...
        /// @dev first month there is no NRT released
    }
    ...
    function claimLaunchReward(uint256 _stakingPlanId) public {
        ...
        for (
            ...
            totalActiveStakings[month] = totalActiveStakings[month].add(reward);
            /// @dev reward means locked ES which only staking option
        }
