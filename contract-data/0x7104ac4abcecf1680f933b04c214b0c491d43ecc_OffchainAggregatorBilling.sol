...
contract OffchainAggregatorBilling is Owned {
  ...
  */
    ...
    )
    {
        ...
        // See s_oracleObservationsCounts docstring
        uint256[maxNumOracles] memory gas;
        // see s_gasReimbursementsLinkWei docstring
   ...
   */
    ...
    internal
    {
        ...
        if (linkWeiAmount > 0) {
            ...
            // "zero" the counts. see var's docstring
    ...
    returns (uint128 gasCostEthWei)
    {
        ...
        // the entire ETH supply fits in a uint128...
   ...
   */
    ...
    returns (uint256 linkDue)
    {
        ...
        for (uint i = 0; i < maxNumOracles; i++) {
            ...
            // Stored value is one greater than actual value
        }
        Billing memory billing = s_billing;
   ...
   */
    ...
    internal
    {
        ...
        // convert from linkGwei to linkWei
